...
% @version  3.5.1
% @log      Made firmware backwards compatible with MATLAB pre-2023b 
%           Error reported 01/21/25 by Kyliana Gailitis (thank you!)
%           - colororder does not exist prior to 2023b
%
%% Terminate
close all; clear; 
